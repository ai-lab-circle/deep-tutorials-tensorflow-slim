...
def nuclei(images, num_classes=2, is_training=False,
  ...
  with tf.variable_scope(scope, 'nuclei', [images]):
...
nuclei.default_image_size = 32


def nuclei_arg_scope(weight_decay=0.004):
  """Defines the default nuclei argument scope.
