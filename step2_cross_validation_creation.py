...
nucleus_dir = './data/1-nuclei/'
postive_path  = './data/1-nuclei/images/postive_images/'
negative_path = './data/1-nuclei/images/negative_images/'
            ...
            for subfi in range(len(subfiles)):
                try:
                    ...
                    for zz in range(len(subfnames)):
                        ...
                        fid.write(negative_path + subfname[0] + '\n')
                        fid.write(negative_path + subfname[1] + '\n')

                    subfnames = subfiles[subfi].fnames_subs_pos
                    for zz in range(len(subfnames)):
                        subfname = subfnames[zz]
                        fid.write(postive_path + subfname[0] + '\n')
                        fid.write(postive_path + subfname[1] + '\n')
                        #fid.write(' 1\n')
                except:
                    print('error')
